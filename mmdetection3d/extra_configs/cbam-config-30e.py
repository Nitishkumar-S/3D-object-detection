...
# updated to load checkpoint
# load_from = 'work_dirs/centerpoint_voxel01_second_secfpn_head-circlenms_8xb4-cyclic-20e_nus-3d/epoch_20.pth'
load_from = None
log_level = 'INFO'
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        in_channels=512,
        loss_bbox=dict(
            type='mmdet.SmoothL1Loss', beta=0.11, reduction='mean', loss_weight=0.25),
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='nuscenes_infos_val_pruned.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        data_prefix=dict(
...
train_cfg = dict(by_epoch=True, max_epochs=30, val_interval=15)
train_dataloader = dict(
    batch_size=4,
    dataset=dict(
        dataset=dict(
            ann_file='nuscenes_infos_train_pruned.pkl',
            backend_args=None,
            box_type_3d='LiDAR',
            data_prefix=dict(
                img='', pts='samples/LIDAR_TOP', sweeps='sweeps/LIDAR_TOP'),
